...
export default function Layout({
  ...
  return (
    <div className="flex flex-row">
      <div className="w-20 md:w-72 border-r fixed border-[#344C64] bg-[#35374B] h-screen">
        <div className="mt-24 flex flex-col gap-y-2 ml-5">
      ...
      <div className="bg-gradient-to-r from-[#eddcd2] to-[#fff1e6] ml-20 md:ml-72 w-[calc(100vw-5rem)] md:w-[calc(100vw-18rem)]">
        {children}
      </div>
    </div>
  );
...
function HomeIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-6 md:w-5">
      <path
        fillRule="evenodd"
