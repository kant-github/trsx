...
export default async function () {
    ...
    return (
        <div className="mt-20 mx-4 md:mx-20 lg:mx-20 h-[84vh] md:h-[86vh]">
            <h1 className="pb-8 md:pb-12 select-none bg-gradient-to-r from-[#0d3b66] to-[#0061ff] bg-clip-text text-center font-bold text-xl text-transparent md:text-xl lg:text-5xl">
